...
# database path
DATABASE_PATH = os.path.join(PROJECT_PATH, 'bms.db')
...
SECRET_KEY = 'er&*@9sm$88%c76n8r^qt+^rv+s-!m_wa#7l$%28ynf@-_&edk'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# please please please please change this before finishing the project
ALLOWED_HOSTS = ['*']
